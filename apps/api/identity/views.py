...
class LoginView(views.APIView):
    ...
    @extend_schema(request=LoginSerializer, responses={200: UserSerializer, 400: OpenApiTypes.OBJECT,
                   (403, "application/json"): OpenApiTypes.OBJECT, (403, "text/html"): OpenApiTypes.STR})
...
class MeView(views.APIView):
    ...
    @extend_schema(responses={200: UserSerializer, 403: OpenApiTypes.OBJECT})
...
class DemoPersonaSwitcherView(views.APIView):
    ...
    @extend_schema(responses={200: serializers.ListSerializer(child=serializers.CharField()), 404: OpenApiTypes.OBJECT})
    def get(self, request):
    ...
    @extend_schema(request=DemoPersonaSwitcherRequestSerializer,
