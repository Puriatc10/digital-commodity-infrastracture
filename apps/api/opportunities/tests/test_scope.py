...
class Epic6ScopeGuardTests(TestCase):
    ...
    def test_opportunities_app_models(self):
        """Confirm that the opportunities app only defines authorized models up to T0607."""
    ...
    def test_no_premature_opportunity_models_registered(self):
        """Confirm no premature qualification, conversion, or Epic 11 operator task models exist."""
        ...
        self.assertNotIn("OpportunityConversion", all_model_names)
        self.assertNotIn("OperatorTask", all_model_names)
